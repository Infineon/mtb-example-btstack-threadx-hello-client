...
wiced_bt_gatt_status_t hello_client_gatt_connection_up( wiced_bt_gatt_connection_status_t *p_conn_status )
{
    ...
    else // Connected as peripheral
    {
        ...
        params.conn_interval_min = 112;
        params.conn_interval_max = 128;
        params.conn_latency = 0;
        params.conn_supervision_timeout = 200;

        wiced_bt_l2cap_update_ble_conn_params(p_conn_status->bd_addr, &params);
